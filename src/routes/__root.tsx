...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Masjid Nale-paar — Azan & Prayer Timetable",
      },

      {
        property: "og:description",
        content:
          "Daily Azan, Jamaat times, monthly timetable, Jumuah, announcements and community events.",
      },
...
function RootComponent() {
  ...
  /*
   * Android Physical / System Back Button
   *
   * This listener handles the Android back button globally.
   *
   * If there is a previous route:
   *     Go to the previous route.
   *
   * If there is no previous route:
